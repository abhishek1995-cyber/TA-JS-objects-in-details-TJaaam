...
foo(); //  Simple function call // true because it is deafult binding and this refers to window
...
let fun1 = user.foo1;
fun1(); // true
user.foo1(); // false here this will be equals to user
...
obj.getX(); // 81 this refers to object here
